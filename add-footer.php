...
{   
    ...
    if(!isset($errMSG))
    {
        if($crud->create_footer($bnama,$burl,$userpic))
        {
        header("Location: add-footer.php?inserted");
        }
        else
        {
        header("Location: add-footer.php?failure");
        } 
    } 
}
?>
...
if(isset($_GET['inserted']))
{
 ...
 <div class="alert alert-info">
    <strong>SUCCESS!</strong>Berita was inserted successfully <a href="listfooter.php">HOME</a>!
 </div>
 </div>
    <?php
}
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-xs-8">
                <label>Nama</label>          
                <input type='text' name='txt_nama' class='form-control' maxlength="30" required>
            </div>
        ...
        <div class="col-xs-8">
            ...
            <a href="listfooter.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Back to index</a>
        </div>
