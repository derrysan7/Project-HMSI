...
if(isset($_GET['id']) && isset($_GET['code']))
{
		...
		if($row['userStatus']==$statusN)
		{
			...
			$msg = "
		           <div class='alert alert-success' style='margin-top:20px;'>
					  Your Account is Now Activated : <a href='lk-portal.php'>Login here</a>
			       </div>
			       ";	
		}
		else
		{
			$msg = "
		           <div class='alert alert-error' style='margin-top:20px;'>
					  Your Account is already Activated : <a href='lk-portal.php'>Login here</a>
			       </div>
			       ";
		}
	}
	else
	{
		$msg = "
		       <div class='alert alert-error' style='margin-top:20px;'>
			   No Account Found : <a href='lk-portal.php'>Login here</a>
			   </div>
			   ";
	}	
}
