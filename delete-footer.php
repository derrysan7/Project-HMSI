...
if(isset($_POST['btn-del']))
{
 ...
 unlink("user_images_footer/".$gambar);
 $crud->delete_footer($id_del);
 header("Location: delete-footer.php?deleted"); 
}
...
if(isset($_GET['delete_id']))
{
 ?>
   <form method="post">
    ...
    <a href="listfooter.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>  
 <?php
}
else
